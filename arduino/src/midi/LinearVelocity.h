...
*/
#ifndef SRC_MIDI_LINEARVELOCITY_H_
#define SRC_MIDI_LINEARVELOCITY_H_

#include "VelocityConverter.h"

class LinearVelocity : public VelocityConverter {
	private:
		byte step;

	public:
		LinearVelocity();
		LinearVelocity(byte step);
...
#endif /* SRC_MIDI_LINEARVELOCITY_H_ */
